...
describe('refusalMessage', () => {
   ...
   * 무엇이 막혔는지까지 말한다.
   *
   * 「막혀 있습니다」만 보면 관리자가 같은 요청을 표현만 바꿔 되풀이한다. 실제로 수정을 끈
  ...
  test('막힌 동작을 설정 화면과 같은 말로 부른다', () => {
    expect(refusalMessage(
      ...
      .toBe('방금 요청은 가드레일 설정에 의해 수정이 금지되어 있습니다. 다른 요청을 해 주세요.')
  })
  ...
  test('삭제는 「가」를 붙인다', () => {
    expect(refusalMessage(
      ...
      .toBe('방금 요청은 가드레일 설정에 의해 삭제가 금지되어 있습니다. 다른 요청을 해 주세요.')
  })
  ...
  test('여러 동작은 설정 화면과 같은 순서로 늘어놓는다', () => {
    expect(refusalMessage(
      ...
      .toBe('방금 요청은 가드레일 설정에 의해 등록, 수정, 삭제가 금지되어 있습니다.'
        + ' 다른 요청을 해 주세요.')
  })
