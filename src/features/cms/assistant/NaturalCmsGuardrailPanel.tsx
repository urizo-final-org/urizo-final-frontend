      ...
      <div className="px-4 pb-4 pt-[0.375rem]">
        {view === null
          ...
          : <>
            ...
            {view.resources.map((resource) => <details key={resource.resourceKey} className="border-b border-row-line last:border-b-0">
              <summary className="flex cursor-pointer items-center gap-2 py-[0.4375rem] text-[0.75rem] text-ink">
                <span className="font-semibold">{RESOURCE_LABELS[resource.resourceKey]}</span>
                <span className="text-[0.6875rem] text-muted-2">필드 {resource.fields.length}</span>
                <span className="ml-auto font-mono text-[0.625rem] text-muted-3">{RESOURCE_SCREENS[resource.resourceKey]}</span>
              </summary>
              <div className="flex flex-wrap gap-x-[0.875rem] gap-y-[0.3125rem] pb-[0.5625rem] pl-[0.875rem]">
    ...
    <section className={`${panel} mt-[0.875rem]`}>
      ...
      <div className="px-4 pb-4 pt-[0.375rem]">
        ...
        <ul className="flex flex-col gap-[0.3125rem]">
          ...
          <li className="flex items-center gap-2 text-[0.71875rem] text-muted-2">실행할 수 있는 도구<span className="ml-auto font-mono text-[0.625rem] text-body">6종</span></li>
        </ul>
